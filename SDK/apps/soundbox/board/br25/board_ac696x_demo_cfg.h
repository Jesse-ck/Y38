...
//                                 FLASH 配置                                      //
//*********************************************************************************//
#define TCFG_NORFLASH_DEV_ENABLE			DISABLE_THIS_MOUDLE //使用A组口，避免PB1 8秒复位，需关闭ini里面PB1的配置。
...
#define MOUNT_SDFILE_REC_PATH   "mnt/rec_sdfile"
#endif
...
#define TCFG_SLIDE_KEY_ENABLE           DISABLE_THIS_MOUDLE

#if TCFG_SLIDE_KEY_ENABLE
/*
 由于滑动变阻器存在差异，所以SLIDE_MAX_AD 建议比真实值小些，SLIDE_MIN_AD 比真实值大写
 并且滑动变阻器一般不是线性变化的，尤其是拉到最大的时候，变阻器会直接跟电路断开,所以S
 LIDE_LEVEL_MAX取的并不是断开电路的那个值，而是未断开电路的最大AD值
 */

#define SLIDE_MSG1                   1
#define SLIDE_MSG2                   2

#define SLIDE_KEY1_IO               IO_PORTB_07
#define SLIDE_KEY1_AD_CHANNEL       AD_CH_PB7
#define SLIDE_KEY1_MSG              SLIDE_MSG1
#define SLIDE_KEY1_MAX_AD			850		//取变阻器未断开电路的最大AD值,具体数值可通过打印ad值来确定
#define SLIDE_KEY1_MIN_AD			740
#define SLIDE_KEY1_MAX_LEVEL		9		//0~9  10 level

#define SLIDE_KEY2_IO               IO_PORTB_06
#define SLIDE_KEY2_AD_CHANNEL       AD_CH_PB6
#define SLIDE_KEY2_MSG              SLIDE_MSG2
#define SLIDE_KEY2_MAX_AD			850
#define SLIDE_KEY2_MIN_AD			740
#define SLIDE_KEY2_MAX_LEVEL		9
...
#define TCFG_PWMLED_IOMODE					LED_ONE_IO_MODE				//LED模式，单IO还是两个IO推灯
#define TCFG_PWMLED_PIN						IO_PORTA_01					//LED使用的IO口
...
#define TCFG_BT_MUSIC_EQ_NUM                10   //最大10

//drc限幅器部分，696x使用全带的限幅器或者压缩器，多带的会跑不过来
...
#define TCFG_CALLING_EN_REVERB               DISABLE//(注意 暂不支持) 通话过程不关闭混响（需关闭AEC）
#else
...
//                                  fm 配置                                     //
//*********************************************************************************//
#define TCFG_FM_ENABLE							ENABLE_THIS_MOUDLE // fm 使能
...
//          数据流节点回调函数使能
//*********************************************************************************//
#define USER_AUDIO_PROCESS_ENABLE     0

//*********************************************************************************//
//            自定义数字音量调节
//*********************************************************************************//
#if (defined(USER_AUDIO_PROCESS_ENABLE) && (USER_AUDIO_PROCESS_ENABLE != 0))
#define USER_DIGITAL_VOLUME_ADJUST_ENABLE     0
#endif
...
//                                 编译警告                                         //
//*********************************************************************************//
#if ((TRANS_DATA_EN || TCFG_ONLINE_ENABLE) && (TCFG_PC_ENABLE || TCFG_UDISK_ENABLE))
